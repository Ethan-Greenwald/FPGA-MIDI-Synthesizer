...
module synthesizer_soc_mm_interconnect_0 (
	...
	wire   [87:0] sdram_s1_agent_rp_data;                                                             // sdram_s1_agent:rp_data -> router_016:sink_data
	...
	wire   [87:0] router_016_src_data;                                                                // router_016:src_data -> sdram_s1_rsp_width_adapter:in_data
	...
	wire  [105:0] sdram_s1_rsp_width_adapter_src_data;                                                // sdram_s1_rsp_width_adapter:out_data -> rsp_demux_014:sink_data
	...
	wire  [105:0] cmd_mux_014_src_data;                                                               // cmd_mux_014:src_data -> sdram_s1_cmd_width_adapter:in_data
	...
	wire  [105:0] cmd_demux_src14_data;                                                               // cmd_demux:src14_data -> crosser:in_data
	wire          cmd_demux_src14_ready;                                                              // crosser:in_ready -> cmd_demux:src14_ready
	wire   [15:0] cmd_demux_src14_channel;                                                            // cmd_demux:src14_channel -> crosser:in_channel
	...
	wire  [105:0] crosser_out_data;                                                                   // crosser:out_data -> cmd_mux_014:sink0_data
	wire          crosser_out_ready;                                                                  // cmd_mux_014:sink0_ready -> crosser:out_ready
	wire   [15:0] crosser_out_channel;                                                                // crosser:out_channel -> cmd_mux_014:sink0_channel
	...
	wire  [105:0] cmd_demux_001_src14_data;                                                           // cmd_demux_001:src14_data -> crosser_001:in_data
	wire          cmd_demux_001_src14_ready;                                                          // crosser_001:in_ready -> cmd_demux_001:src14_ready
	wire   [15:0] cmd_demux_001_src14_channel;                                                        // cmd_demux_001:src14_channel -> crosser_001:in_channel
	...
	wire  [105:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux_014:sink1_data
	wire          crosser_001_out_ready;                                                              // cmd_mux_014:sink1_ready -> crosser_001:out_ready
	wire   [15:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_014:sink1_channel
	...
	wire  [105:0] rsp_demux_014_src0_data;                                                            // rsp_demux_014:src0_data -> crosser_002:in_data
	wire          rsp_demux_014_src0_ready;                                                           // crosser_002:in_ready -> rsp_demux_014:src0_ready
	wire   [15:0] rsp_demux_014_src0_channel;                                                         // rsp_demux_014:src0_channel -> crosser_002:in_channel
	...
	wire  [105:0] crosser_002_out_data;                                                               // crosser_002:out_data -> rsp_mux:sink14_data
	wire          crosser_002_out_ready;                                                              // rsp_mux:sink14_ready -> crosser_002:out_ready
	wire   [15:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink14_channel
	...
	wire  [105:0] rsp_demux_014_src1_data;                                                            // rsp_demux_014:src1_data -> crosser_003:in_data
	wire          rsp_demux_014_src1_ready;                                                           // crosser_003:in_ready -> rsp_demux_014:src1_ready
	wire   [15:0] rsp_demux_014_src1_channel;                                                         // rsp_demux_014:src1_channel -> crosser_003:in_channel
	...
	wire  [105:0] crosser_003_out_data;                                                               // crosser_003:out_data -> rsp_mux_001:sink14_data
	wire          crosser_003_out_ready;                                                              // rsp_mux_001:sink14_ready -> crosser_003:out_ready
	wire   [15:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux_001:sink14_channel
