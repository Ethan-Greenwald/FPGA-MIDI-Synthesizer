...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../synthesizer_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is synthesizer_soc
SOPC_NAME := synthesizer_soc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80012d0
SOPC_SYSID_FLAG += --sidp=0x80012d0
ELF_PATCH_FLAG  += --sidp 0x80012d0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1682793879
SOPC_SYSID_FLAG += --timestamp=1682793879
ELF_PATCH_FLAG  += --timestamp 1682793879
